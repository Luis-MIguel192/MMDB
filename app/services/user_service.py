...
class UserService:
    ...
    def registrar_usuario(cls,
        ...
        try:
            ...
            usuario.ativo = True  # Ativação automática para desenvolvimento
            usuario.dta_validacao_email = datetime.now()  # Marca como validado
            ...
            # Ativação automática - não precisa enviar email
